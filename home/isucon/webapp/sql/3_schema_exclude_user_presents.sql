...
ALTER TABLE users AUTO_INCREMENT=100000000001;
...
ALTER TABLE user_decks AUTO_INCREMENT=100000000001;
...
ALTER TABLE user_bans AUTO_INCREMENT=100000000001;
...
ALTER TABLE user_devices AUTO_INCREMENT=100000000001;
...
ALTER TABLE login_bonus_masters AUTO_INCREMENT=100000000001;
...
ALTER TABLE login_bonus_reward_masters AUTO_INCREMENT=100000000001;
...
ALTER TABLE user_login_bonuses AUTO_INCREMENT=100000000001;
...
ALTER TABLE present_all_masters AUTO_INCREMENT=100000000001;
...
ALTER TABLE user_present_all_received_history AUTO_INCREMENT=100000000001;
...
ALTER TABLE gacha_masters AUTO_INCREMENT=100000000001;
...
ALTER TABLE gacha_item_masters AUTO_INCREMENT=100000000001;
...
CREATE TABLE `user_items` (
  ...
  `deleted_at` bigint default NULL,
  PRIMARY KEY (`id`),
  UNIQUE userid_idx (`user_id`, `item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
ALTER TABLE user_cards AUTO_INCREMENT=100000000001;
...
ALTER TABLE item_masters AUTO_INCREMENT=100000000001;
...
ALTER TABLE version_masters AUTO_INCREMENT=100000000001;
...
ALTER TABLE admin_users AUTO_INCREMENT=100000000001;
